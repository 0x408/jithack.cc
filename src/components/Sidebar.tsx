...
export const Sidebar = () => {
    ...
    return (
        <aside className="fixed top-0 left-0 z-40 w-64 h-screen">
            <div className="h-full py-4 overflow-y-auto bg-[#111]/50">
                <ul className="space-y-1">
                    <li>
                        <p className={`text-center ${checked ? "text-purple-500" : "text-[#B5290B]"}`}>jithack.cc</p>
                    </li>
                    <li>
                        <NavLink to="/panel/home" className={({ isActive }) => 
                            isActive ? `flex items-center p-2.5 text-white border ${checked ? "border-purple-500/75" : "border-[#B5290B]/75"}` : `flex items-center p-2.5 text-white border border-transparent ${checked ? "hover:border-purple-500/75" : "hover:border-[#B5290B]/75"}`
                        }>
                    ...
                    <li>
                        <NavLink to="/panel/my-profile" className={({ isActive }) => 
                            isActive ? `flex items-center p-2.5 text-white border ${checked ? "border-purple-500/75" : "border-[#B5290B]/75"}` : `flex items-center p-2.5 text-white border border-transparent ${checked ? "hover:border-purple-500/75" : "hover:border-[#B5290B]/75"}`
                        }>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-4 h-4 mr-2">
                    ...
                    <li>
                        <NavLink to="/panel/subs" className={({ isActive }) => 
                            isActive ? `flex items-center p-2.5 text-white border ${checked ? "border-purple-500/75" : "border-[#B5290B]/75"}` : `flex items-center p-2.5 text-white border border-transparent ${checked ? "hover:border-purple-500/75" : "hover:border-[#B5290B]/75"}`
                        }>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-4 h-4 mr-2">
                    ...
                    <li>
                        <NavLink to="/panel/settings" className={({ isActive }) => 
                            isActive ? `flex items-center p-2.5 text-white border ${checked ? "border-purple-500/75" : "border-[#B5290B]/75"}` : `flex items-center p-2.5 text-white border border-transparent ${checked ? "hover:border-purple-500/75" : "hover:border-[#B5290B]/75"}`
                        }>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-4 h-4 mr-2">
                    ...
                    <li>
                        <NavLink to="/panel/admin" className={({ isActive }) => 
                            isActive ? `flex items-center p-2.5 text-white border ${checked ? "border-purple-500/75" : "border-[#B5290B]/75"}` : `flex items-center p-2.5 text-white border border-transparent ${checked ? "hover:border-purple-500/75" : "hover:border-[#B5290B]/75"}`
                        }>
