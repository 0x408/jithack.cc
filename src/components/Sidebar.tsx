        ...
        <aside className="fixed top-0 left-0 z-40 w-64 h-screen">
            <div className="h-full py-4 overflow-y-auto bg-[#111]/50">
                <ul className="space-y-1">
                    <li>
                        <p className={`text-center ${checked ? `text-[${randomColor}]` : "text-[#B5290B]"}`}>jithack.cc</p>
                    </li>
                    <li>
                        <NavLink to="/panel/home" className={({ isActive }) => 
                            isActive ? `flex items-center p-2.5 text-white border ${checked ? `border-[${randomColor}]` : "border-[#B5290B]/75"}` : `flex items-center p-2.5 text-white border border-transparent ${checked ? `hover:border-[${randomColor}]` : "hover:border-[#B5290B]/75"}`
                        }>
